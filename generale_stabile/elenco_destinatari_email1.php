...
{
  echo "Creazione generale_stabile/elenco_destinatari_email1; \r\n";
...
{
  echo "Importazione da access di: elenco_destinatari_email1 in  generale_stabile/elenco_destinatari_email1; \r\n";
    $sql = 'SELECT ';
    $sql .= 'rif_lettera, ';
    $sql .= 'codice, ';
    $sql .= 'scala, ';
